...
# El fixture vigente es el v3. Los v1 y v2 están congelados (`fixtures/**` solo se añade)
...
FAKE = Path("fixtures/run_fake_v3.jsonl")
GEN = Path("scripts/fake_journal.py")

pytestmark = pytest.mark.skipif(
    not FAKE.exists(),
    reason="falta fixtures/run_fake_v3.jsonl · uv run python scripts/fake_journal.py",
)
