// Iconos de las cuatro vistas. SVG en línea: sin librería de iconos (SPEC-008 REQ-270).
  ...
  return (
    ...
    >
      {view === 'dashboards' ? (
        ...
        <>
          {/* Un play dentro de un marco: algo que se ejecuta, no un sitio al que se va. */}
